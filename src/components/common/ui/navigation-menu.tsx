...
/**
 * Shared style for navigation menu triggers
 */
...
/**
 * The main navigation menu container component
 */
...
/**
 * Clickable trigger that opens navigation menu content
 */
...
/**
 * Content container that appears when trigger is activated
 */
...
/**
 * Viewport that displays the active navigation menu content
 */
...
/**
 * Visual indicator showing the active navigation item
 */
